...
func (in *RepoSpec) DeepCopyInto(out *RepoSpec) {
	*out = *in
	...
	if in.FromRepoCredentials != nil {
		in, out := &in.FromRepoCredentials, &out.FromRepoCredentials
		*out = new(RepoCredentials)
		(*in).DeepCopyInto(*out)
	}
	if in.ToRepoCredentials != nil {
		in, out := &in.ToRepoCredentials, &out.ToRepoCredentials
		*out = new(RepoCredentials)
		(*in).DeepCopyInto(*out)
	}
	if in.Insecure != nil {
